...
namespace PEIU.Events
{
    public class EventPublisherWorker : AbsMqttPublisher
    {
        ...
        protected override string GetMqttPublishTopicName()
        {
            ...
            return $"hubbub/{SiteId}/{DeviceId}/OridinaryEvent";
        }

        public Task PublishEvent(int SiteId, string DeviceId, int EventCode, EventStatus status, CancellationToken token)
        {
